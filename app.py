...
#MULT CHOICE
    ...
    elif text=="/mult-bodoh" or text=="bodoh" or text=="bodo" or data[0]=="bodoh" or data[1]=="bodoh" or data[0]=="bodo" or data[1]=="bodo":
...
#PUN
    ...
    #3 MULT CHOICE
    elif text=="/pun-bego" or data[0]=="bego" or data[1]=="bego":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #4 MULT CHOICE
    elif text=="/pun-ngegas" or data[0]=="ngegas" or data[1]=="ngegas":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #5 MULT CHOICE
    elif text=="/pun-gas" or data[0]=="gas" or data[1]=="gas":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #6
    elif text=="/pun-gawat" or text=="gawat" or data[0]=="gawat" or data[1]=="gawat":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #6
    elif text=="/pun-gelut" or data[0]=="gelut" or data[1]=="gelut":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    original_content_url='https://pics.me.me/gelut-29735709.png',
    preview_image_url='https://pics.me.me/gelut-29735709.png'
    ))
    #7 MULT CHOICE
    elif text=="/pun-ikan-goblok" or data[0]=="goblok" or data[1]=="goblok" or data[0]=="gblk" or data[1]=="gblk" or data[0]=="goblog" or data[1]=="goblog" or data[0]=="gblg" or data[1]=="gblg":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #8
    elif text=="/pun-bubar" or data[0]=="bubar" or data[0]=="leren" or data[1]=="bubar" or data[1]=="leren":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #9
    elif text=="/pun-kancil" or data[0]=="kancil" or data[1]=="kancil":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #10
    elif text=="/pun-kecewa" or data[0]=="kecewa" or data[1]=="kecewa":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    original_content_url='https://pics.me.me/kecewa-31619297.png',
    preview_image_url='https://pics.me.me/kecewa-31619297.png'
    ))
    #11
    elif text=="/pun-keren" or data[0]=="keren" or data[0]=="cool" or data[0]=="kewl" or data[1]=="keren" or data[1]=="cool" or data[1]=="kewl":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #12
    elif text=="/pun-kocak" or data[0]=="kocak" or data[0]=="ngakak" or data[1]=="kocak" or data[1]=="ngakak":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #13
    elif text=="/pun-lodeh" or data[1]=="terserah" or data[1]=="serah" or data[1]=="seterah" or data[0]=="terserah" or data[0]=="serah" or data[0]=="seterah":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #14
    elif text=="/pun-mager" or data[0]=="mager" or data[1]=="mager":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #15
    elif text=="/pun-pinter" or data[0]=="pinter" or data[0]=="pintar" or data[0]=="smart" or data[1]=="pinter" or data[1]=="pintar" or data[1]=="smart":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #16
    elif text=="/pun-sabi" or data[0]=="sabi" or data[0]=="bisa" or data[1]=="sabi" or data[1]=="bisa":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #17
    elif text=="/pun-sekip" or data[0]=="skip" or data[0]=="sekip" or data[0]=="sqip" or data[0]=="sqiv" or data[1]=="skip" or data[1]=="sekip" or data[1]=="sqip" or data[1]=="sqiv":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #18
    elif text=="/pun-siyap" or data[0]=="siap" or data[0]=="siyap" or data[0]=="shap" or data[0]=="ready" or data[0]=="siaap" or data[1]=="siap" or data[1]=="siyap" or data[1]=="shap" or data[1]=="ready" or data[1]=="siaap":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #20
    elif text=="/pun-thanks" or data[0]=="thanks" or data[0]=="thank" or data[0]=="makasih" or data[0]=="trims" or data[0]=="thx" or data[0]=="maaci" or data[1]=="thanks" or data[1]=="thank" or data[1]=="makasih" or data[1]=="trims" or data[1]=="thx" or data[1]=="maaci":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
    ...
    #21
    elif text=="/pun-kampret" or data[0]=="kampret" or data[1]=="kampret":
        line_bot_api.reply_message(event.reply_token,ImageSendMessage(
